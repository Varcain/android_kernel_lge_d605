/* arch/arm/mach-msm/qdsp5v2/tpa2055-amp.h
 *
...
/* ------- IC Control Register (0x01) -------*/
#define NG_EN				(char) 0x01
#define THERMAL				(char) 0x04
#define FAULT				(char) 0x08
#define SWS				(char) 0x20
#define EN				(char) 0x40

#if 0
/* -------- AGC Attack CONTROL Register (0x02) ---------*/
