...
#define ECRYPTFS_I_SIZE_INITIALIZED   0x00004000
	...
	/* [WBT]kernel/fs/ecryptfs/crypto.c => ecryptfs_new_file_context() :
	 * Buffer overflow, array index of 'cipher' may be out of bounds. Array 'cipher' of size 32 may use index value(s) 32
	 * ECRYPTFS_MAX_CIPHER_NAME_SIZE -> ECRYPTFS_MAX_CIPHER_NAME_SIZE + 1 */
