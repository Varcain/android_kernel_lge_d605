...
static struct pm8xxx_gpio_init pm8038_gpios[] __initdata = {
	...
	PM8038_GPIO_INPUT(2, PM_GPIO_PULL_UP_30),
	PM8038_GPIO_INPUT(3, PM_GPIO_PULL_UP_30),
#if !(defined(CONFIG_MACH_LGE_F6_TMUS) || defined(CONFIG_MACH_LGE_F6_VDF) || defined(CONFIG_MACH_LGE_F6_ORG ) || defined(CONFIG_MACH_LGE_F6_OPEN) || defined(CONFIG_MACH_LGE_F6_TMO)) || !defined(CONFIG_MACH_LGE_L9II_COMMON)
