...
* $Id: dhd_wlfc.h 410252 2013-06-28 18:04:06Z $
*
*/
...
typedef struct wlfc_hanger {
	...
	wlfc_hanger_item_t *free_list_head;
	wlfc_hanger_item_t *free_list_tail;
...
typedef struct dhd_pkttag {
	/*
	b[15 ] - 1 = packet is sent from proptxstatus module
