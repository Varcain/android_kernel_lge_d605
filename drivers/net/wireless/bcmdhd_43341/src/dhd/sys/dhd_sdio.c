 ...
 *
 * $Id: dhd_sdio.c 410252 2013-06-28 18:04:06Z $
 */
...
/* Total length of TX frame header for dongle protocol, including tx glom headers */
...
dhdsdio_probe_malloc(dhd_bus_t *bus, osl_t *osh, void *sdh)
{
	...
	if (bus->dhd->maxctl) {
		bus->rxblen = ROUNDUP((bus->dhd->maxctl+SDPCM_HDRLEN_RX), ALIGNMENT) + DHD_SDALIGN;
