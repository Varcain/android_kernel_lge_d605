 ...
 *
 * $Id: wlioctl.h 402063 2013-05-14 14:38:47Z $
 */
...
typedef struct wl_nic_cfg {
	...
	uint8 CWmin_af;
	uint8 NIC_priority;
	uint8 NIC_data_ind;	/* Keeping this variable for tracking */
				/* debug purposes. Host keeps its own */
				/* copy of this config value and sends */
				/* WLAN TO NIC DATA IND message based on it */
