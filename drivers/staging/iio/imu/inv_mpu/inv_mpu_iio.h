 ...
 *  @bias_thresh:	gyro bias thresh.
 *  @rms_thresh:	gyro rms thresh
 */
struct test_setup_t {
	int gyro_sens;
    int accel_sens;
    ...
    int bias_thresh;
    int rms_thresh;
	int accl_z_bias_thresh;
	int accl_xy_bias_thresh;
	int accl_rms_thresh;
};
...
int inv_accel_test(struct inv_mpu_iio_s *st,
		int *accel_bias, int *accel_rms, int *accel_lsb_bias);
